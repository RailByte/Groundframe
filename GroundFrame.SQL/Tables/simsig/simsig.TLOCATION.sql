...
(
	...
	CONSTRAINT FG_SIMSIG_TLOCATION_CREATEDBY_APP_TUSER FOREIGN KEY ([createdby_id]) REFERENCES [app].[TUSER] ([id]),
	CONSTRAINT FG_SIMSIG_TLOCATION_CREATEDBY_APP FOREIGN KEY ([createdby_app_id]) REFERENCES [app].[TAPP] ([id]),
	CONSTRAINT FG_SIMSIG_TLOCATION_MODIFIEDBY_APP_TUSER FOREIGN KEY ([modifiedby_id]) REFERENCES [app].[TUSER] ([id]),
	CONSTRAINT FG_SIMSIG_TLOCATION_MODIFIEDBY_APP FOREIGN KEY ([modifiedby_app_id]) REFERENCES [app].[TAPP] ([id]),
