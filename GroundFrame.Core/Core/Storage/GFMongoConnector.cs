...
{
    /// <summary>
    /// A class representing a connection to a GroundFrame.MongoDB database. Designed to enable a consistent approach to connecting to a mongo database
    /// </summary>
    public class GFMongoConnector : IDisposable
    {
        #region Private Variables

        private readonly MongoClient _MongoClient; //Private variable to store the MongoClient
        private readonly string _Server; //Private vraiable to store the Server (name or IP)
        private readonly string _Port; //Private variable to store the Port
