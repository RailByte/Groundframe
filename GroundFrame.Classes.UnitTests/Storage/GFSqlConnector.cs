...
namespace GroundFrame.Classes.UnitTests.Storage
{
    public class GFSqlConnector
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => new GroundFrame.Classes.GFSqlConnector(AppAPIKey, AppUserAPIKey, this._SQLServer, this._DBName).Open());
        }
        ...
        {
            Classes.GFSqlConnector TestSQLConnector = new Classes.GFSqlConnector("testappAPIKEY", "testuserAPIKEY", this._SQLServer, this._DBName);
        ...
        {
            Classes.GFSqlConnector TestSQLConnector = new Classes.GFSqlConnector("testappAPIKEY", "testuserAPIKEY", this._SQLServer, this._DBName, true);
