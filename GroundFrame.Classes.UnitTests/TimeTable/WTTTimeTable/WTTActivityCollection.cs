...
namespace GroundFrame.Classes.UnitTests.TimeTable.WTTTimeTable
{
    ...
    public class WTTActivityCollection
    {
        ...
        public void WTTActivityCollection_Constructor_XElement()
        {
            ...
            GroundFrame.Classes.Timetables.WTTActivityCollection TestActivityCollection  = new Timetables.WTTActivityCollection(XMLTestActivityCollection);
        ...
        public void WTTActivityCollection_Constructor_JSON()
        {
            ...
            GroundFrame.Classes.Timetables.WTTActivityCollection TestJSONActivityCollection = new Timetables.WTTActivityCollection(JSON);
