...
namespace GroundFrame.Classes.UnitTests.WTT.WTTTrainCategoryCollection
{
    public class WTTTrainCategoryCollection
    {
        ...
        public void WTTTrainCategoryCollection_Constuctor_XElement()
        {
            ...
            GroundFrame.Classes.Timetables.WTTTrainCategoryCollection TestTrainCollection = new GroundFrame.Classes.Timetables.WTTTrainCategoryCollection(TestXML);
        ...
        public void WTTTrainCategoryCollection_Method_IndexOf()
        {
            ...
            Assert.Equal(new GroundFrame.Classes.Timetables.WTTSpeed(Convert.ToInt32(TestXML.Elements("TrainCategory").First().Element("MaxSpeed").Value.ToString())).MPH, TestTrainCategory.MaxSpeed.MPH);
            ...
            Assert.Equal(new GroundFrame.Classes.Timetables.WTTSpeedClass(Convert.ToInt32(TestXML.Elements("TrainCategory").First().Element("SpeedClass").Value.ToString())).Bitwise, TestTrainCategory.SpeedClass.Bitwise);
        ...
        public void WTTTrainCategoryCollection_Method_ToJSON()
        {
            ...
            GroundFrame.Classes.Timetables.WTTTrainCategoryCollection JSONWTTrainCollection = new Timetables.WTTTrainCategoryCollection(JSONTrainCollection);
