...
namespace GroundFrame.Core.UnitTests.TimeTable.WTTTrainCategory
{
    /// <summary>
    ...
    public class WTTTrainCategory
    {
        ...
        public void WTTTrainCategory_Constructor_XElement()
        {
            ...
            Assert.Equal(new GroundFrame.Core.Timetables.WTTSpeed(Convert.ToInt32(XMLTestTrainCategory.Element("MaxSpeed").Value.ToString())).MPH, TestCategory.MaxSpeed.MPH);
            Assert.Equal(new GroundFrame.Core.Length(Convert.ToInt32(XMLTestTrainCategory.Element("TrainLength").Value.ToString())).Meters, TestCategory.TrainLength.Meters);
            Assert.Equal(new GroundFrame.Core.Timetables.WTTSpeedClass(Convert.ToInt32(XMLTestTrainCategory.Element("SpeedClass").Value.ToString())).Bitwise, TestCategory.SpeedClass.Bitwise);
            ...
            Assert.Equal(new GroundFrame.Core.Electrification(XMLTestTrainCategory.Element("Electrification").Value.ToString()).Overhead, TestCategory.Electrification.Overhead);
        ...
        public void WTTTrainCategory_Constructor_NullXMLException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new GroundFrame.Core.Timetables.WTTTrainCategory(NullXElement));
        }
        ...
        {
            string JSON = null;
            Assert.Throws<ArgumentNullException>(() => new GroundFrame.Core.Timetables.WTTTrainCategory(JSON));
        }
        ...
        public void WTTTrainCategory_Constructor_InvalidJSONException()
        {
            ...
            Assert.Throws<FormatException>(() => new GroundFrame.Core.Timetables.WTTTrainCategory(JSON));
        }
